https://github.com/mljalloh336-ui/MSC_data_analytics.m.j
...
<head>
    <title>Mariama Jalloh| Portfolio Hub</title>
    <meta charset="utf-8">
...
<body id="home">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#home">Mariama Jalloh</a>
    ...
    <div class="jumbotron jumbotron-fluid text-center hero">
        <div class="container">
            <h1 class="display-4 mt-5">
                Hello, I’m <span class="highlight"> Mariama Jalloh </span>
            </h1>
            <p class="lead mt-3">
                Data Analytics Educator • Course Creator • Former Frontend Developer
            </p>
    ...
    <footer id="footer">
        <ul class="socicons-list">
            ...
            <li>
                <a href="https://www.linkedin.com/in/mariama-j-399428207/" target="_blank"
                    aria-label="LinkedIn">
    ...
    <p class="copyright text-center mb-3">
        Vivian Edema &copy; <span id="year"></span>
    </p>
